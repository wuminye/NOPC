...
class Random_Transforms(object):
    def __init__(self, size, random_range = 0, random_ration = 0, random_rotation = 0,interpolation=Image.BICUBIC, isTrain = True):
    ...
    def __call__(self, img, Ks = None, Ts = None,  mask = None, refCenter = None):
...
def build_transforms(cfg, is_train=True):
    ...
    if is_train: 
        ...
        transform = Random_Transforms((cfg.INPUT.SIZE_TEST[1], cfg.INPUT.SIZE_TEST[0]),0, isTrain = False)
        # transform = T.Compose([
